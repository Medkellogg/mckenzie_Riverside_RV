/**********************************************************************
*    Jeroen Gerritsen's B&O McKenzie Division - 
*    by: Mark Kellogg                          
***********************************************************************
...
-----------------------------------------------------------------------
*
*                    RIVERSIDE RV CONTROL SOFTWARE
* This code is for use on the Main Driver Control Board and its purpose
* is to control the 5 turnouts and associated LEDs on the Riverside RV
* Control Panel.  S1 through S6 drivers control the Tortoises
* associated with the interchange.  S7 through S14 control the LEDs.  
